...
class CategoryTableSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('categories')->insert([
            ...
            ['id' => '8', 'position' => '3', 'image' => null, 'status' => '1', '_lft' => '11', '_rgt' => '12', 'parent_id' => '1', 'created_at' => $now, 'updated_at' => $now],
        ]);
        ...
        DB::table('category_translations')->insert([
            ...
            ['id' => '8', 'name' => 'Shoes', 'slug' => 'shoes', 'description' => 'Shoes', 'meta_title' => '', 'meta_description' => '', 'meta_keywords' => '', 'category_id' => '8', 'locale' => 'en'],
        ]);
    }
}
